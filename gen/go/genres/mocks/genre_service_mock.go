...
//
//	mockgen -source=genre_service_grpc.pb.go -destination=./mocks/genre_service_mock.go
//
...
func (m *MockGenreClient) GetAll(ctx context.Context, in *shared_pb.Empty, opts ...grpc.CallOption) (*genres_pb.GetAllResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
...
func (mr *MockGenreClientMockRecorder) GetAll(ctx, in any, opts ...any) *gomock.Call {
...
func (mr *MockGenreClientMockRecorder) GetOneOf(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
...
func (mr *MockGenreClientMockRecorder) GetTree(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
...
// GetAll mocks base method.
func (m *MockGenreServer) GetAll(arg0 context.Context, arg1 *shared_pb.Empty) (*genres_pb.GetAllResponse, error) {
	m.ctrl.T.Helper()
...
// GetAll indicates an expected call of GetAll.
func (mr *MockGenreServerMockRecorder) GetAll(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetOneOf indicates an expected call of GetOneOf.
func (mr *MockGenreServerMockRecorder) GetOneOf(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetTree indicates an expected call of GetTree.
func (mr *MockGenreServerMockRecorder) GetTree(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
