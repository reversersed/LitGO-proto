...
type CategoryModel struct {
	...
	TranslitName string        `protobuf:"bytes,3,opt,name=translitName,json=translitname,proto3" json:"translitName,omitempty"`
...
type GenreModel struct {
	...
	Name         string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	TranslitName string `protobuf:"bytes,3,opt,name=translitName,json=translitname,proto3" json:"translitName,omitempty"`
	BookCount    int64  `protobuf:"varint,4,opt,name=bookCount,json=bookcount,proto3" json:"bookCount,omitempty"`
}
